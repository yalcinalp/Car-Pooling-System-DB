...
public class Evaluation {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //6.1   18 Find trips departing from the given city
            addDivider(bufferedWriter);
            ...
            //6.2   19 Find all trips that have never been booked
            addDivider(bufferedWriter);
            ...
            //6.3   20 For each driver, find the trip(s) with the highest number of bookings
            addDivider(bufferedWriter);
